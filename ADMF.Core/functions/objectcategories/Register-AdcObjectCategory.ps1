function Register-AdcObjectCategory {
	<#
	.SYNOPSIS
	...
	.EXAMPLE
		PS C:\> Register-AdcObjectCategory -Name DomainController -ObjectClass computer -Property PrimaryGroupID -TestScript { $args[0].PrimaryGroupID -eq 516 } -LDAPFilter '(&(objectCategory=computer)(primaryGroupID=516))'
		
		Registers an object category applying to all domain controller's computer object in AD.
#>
	[Alias('Register-DMObjectCategory')]
