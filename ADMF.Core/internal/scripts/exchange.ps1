...
$script:exchangeVersionMapping = @{
	...
	'2016CU18' = [PSCustomObject]@{ Name = 'Exchange 2016 CU18'; ObjectVersionDefault = 13238; ObjectVersionConfig = 16218; RangeUpper = 15332; Binding = '2016CU18' }
	'2016CU19' = [PSCustomObject]@{ Name = 'Exchange 2016 CU19'; ObjectVersionDefault = 13239; ObjectVersionConfig = 16219; RangeUpper = 15333; Binding = '2016CU19' }
	...
	'2019CU7' = [PSCustomObject]@{ Name = 'Exchange 2019 CU7'; ObjectVersionDefault = 13238; ObjectVersionConfig = 16755; RangeUpper = 17001; Binding = '2019CU7' }
	'2019CU8' = [PSCustomObject]@{ Name = 'Exchange 2019 CU8'; ObjectVersionDefault = 13239; ObjectVersionConfig = 16756; RangeUpper = 17002; Binding = '2019CU8' }
}